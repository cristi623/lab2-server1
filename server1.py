...
import json
server = FastAPI()
# mysql://a7l327l8pa1hprb3:odum19euj7zgsf2q@nuepp3ddzwtnggom.chr7pe7iynqr.eu-west-1.rds.amazonaws.com:3306/v9tnql0hfdy5a6wp
db = connect(host="nuepp3ddzwtnggom.chr7pe7iynqr.eu-west-1.rds.amazonaws.com", port=3306, user="a7l327l8pa1hprb3", password="odum19euj7zgsf2q", db="v9tnql0hfdy5a6wp")
@server.get('/')
async def home():
